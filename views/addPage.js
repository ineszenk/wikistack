...
module.exports = () => layout(html`
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input id="title" name="email" type="text" class="form-control"/></div>
      </div>
      </div>
    ...
    <div class="col-sm-10">
      <input id="title" name="content" type="text" class="form-control"/></div>
      </div>
      </div>
    ...
    <div class="col-sm-10">
      <input id="title" name="status" type="text" class="form-control"/></div>
      </div>
      </div>
